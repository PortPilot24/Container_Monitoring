...
router = APIRouter(prefix="/container-monitoring", tags=["affiliation"])

@router.get("/affiliation-containers")
def get_containers_by_affiliation(affiliation: str = Query(None)):
    if not affiliation:
